...
$arrayMovieName = "Double Dhamaal (2011)";

$arrayMovieOMDB = "Double Dhamaal";

$year = 2011;

$titleFix = str_replace(" ", "+", $arrayMovieOMDB);

$url = "http://www.omdbapi.com/?t=$titleFix&y=$year&apikey=7c248fee";
...
$ep = str_replace(" ", "-", $epL);
	...
	if($plot == ""){
	     ...
	     $lower = strtolower($arrayMovieName);
...
$html2 = file_get_html($movieLink);

$videoId = $html2->find('#videolink',0);

$linkmp4 = "http://woof.tube/gettoken/".$videoId;

$link = str_replace(" ", "", $linkmp4);
